...
DECLARE
  ...
  -- Test 37 variables
  v_foreign_owner_id    uuid := '77777777-7777-4777-a777-777777777737'::uuid;
...
BEGIN
  ...
  VALUES (v_foreign_owner_id, '00000000-0000-0000-0000-000000000000', 'foreign_owner_test37@test.invalid', '$2a$10$abcdefghijklmnopqrstuu', now(), '{"provider":"email","providers":["email"]}', '{}', now(), now(), 'authenticated', 'authenticated')
