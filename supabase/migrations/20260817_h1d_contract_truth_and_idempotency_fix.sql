-- =========================================================================
-- MIGRATION 42: H1D CONTRACT TRUTH AND IDEMPOTENCY FIX
-- Migration file: 20260817_h1d_contract_truth_and_idempotency_fix.sql
-- Substantive forward-only redefinitions for:
...
-- Enforces mandatory idempotency key, structured conflict & replay envelopes,
-- and Boolean OR directory filter.
-- =========================================================================
