...
## Salon Owner / Tenant Admin (`admin@randevulari.com`)
...
## Super Admin (`superadmin@randevulari.com`)
...
- `admin@randevulari.com` / `admin123` (Salon Owner)
- `superadmin@randevulari.com` / `superadmin123` (Super Admin)
