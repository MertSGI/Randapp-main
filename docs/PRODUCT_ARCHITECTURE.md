...
- **Goal:** Act as a conversion-focused landing site emphasizing that lari provides a "Mini Website + Online Booking + AI Advisor" instead of just a raw booking widget.
...
- **Rule:** It must *never* show "Demo Oluştur", "Yönetici Paneli" or global lari marketing links.
