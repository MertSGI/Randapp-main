...
This guide walks you through setting up an iyzico Sandbox merchant account, obtaining credentials, and configuring LARÄ°.
...
1. Create a **Product** mapping to LAR\u0130 (e.g., "LAR\u0130 Subscriptions").
...
## Step 4: Configure LAR\u0130 Super Admin
1. Log into your LAR\u0130 instance as a Super Admin (`superadmin@randevulari.com`).
2. Go to **Plans**.
